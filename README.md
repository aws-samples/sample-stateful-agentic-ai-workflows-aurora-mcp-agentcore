...
![The Meridian product view: a full-bleed Amalfi Coast hero beside Bali and Barcelona, with the capability ladder across the top and four personalization pills citing the Aurora rows behind them - saved budget, boutique lodging, a shellfish allergy from a support ticket, and home airport](meridian/docs/meridian-showcase.png)
