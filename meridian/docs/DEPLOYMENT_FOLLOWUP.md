...
## Encryption cutover procedure

The existing unencrypted cluster cannot become encrypted in place. [Aurora supports restoring its snapshot into an encrypted replacement](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Overview.Encryption.html). The migration must preserve all journeys, checkpoints, identity bindings and business records.
