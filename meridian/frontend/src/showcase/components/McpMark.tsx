 ...
 *
 * Unlike the AWS service tiles this is stroke art with no fill, so it is
 * inlined rather than loaded as an image: that lets the stroke take
 * currentColor and follow whatever chip or heading it sits in, in either
 * theme. Loaded as an <img> its black stroke disappeared against the navy.
 */
