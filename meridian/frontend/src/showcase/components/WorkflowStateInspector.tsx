import { DatabaseZap, GitBranch, Route } from 'lucide-react';
...
export function WorkflowStateInspector({ state }: { state: MeridianShowcaseState }) {
  ...
  return (
    <section className={`mds-workflow-state is-${workflow.status}`} aria-label="Workflow state inspector">
      <div className="mds-workflow-state-head">
