"""
Meridian trip catalog — 35 packages across 7 series of five.
...
CATALOG_IMAGE_ROOT = "/travel/catalog"
...
def _pkg(
    ...
    return {
        ...
        "image_url": f"{CATALOG_IMAGE_ROOT}/{package_id}.jpg",
        "durations": durations,
...
TRIP_PACKAGES = [
    ...
    # Seasonal Tokyo. The other four TKY packages split by traveller type -
    # independent, family, business, luxury - and none of them answer "when".
    # Priced inside the demo traveller's saved 2000-3500 band so it reads as a
    # budget match rather than a caution.
    _pkg("TKY-005", "Tokyo Autumn Koyo & Day Trips", "City Breaks", "Tokyo", "Asia-Pacific", 2799.0,
         "JTB Sunrise Tours",
         "Autumn foliage timed for mid-October, Rikugien and Meiji Jingu Gaien walks,"
         " day trips to Nikko and Kamakura, rail pass and reserved seats included.",
         ["6 nights", "8 nights"],
         {"6 nights": 7, "8 nights": 5},
         ["koyo season", "rail pass", "day trips"]),
]
